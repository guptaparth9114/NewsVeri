        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Bringing you the latest news with insightful sentiment analysis and fake news detection.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/category/entertainment" className="text-gray-300 hover:text-white transition-colors">Entertainment</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/premium" className="text-gray-300 hover:text-white transition-colors">Premium Subscription</Link></li>
