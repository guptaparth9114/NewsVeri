  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
      <div className="p-4">
        ...
        <p className="text-gray-600 mb-4 line-clamp-3">{news.description || 'No description available'}</p>
        
        <div className="flex items-center justify-between text-sm">
          <span className="text-gray-500">
            {getFormattedDate(news.published_at)}
          </span>
          
          <div className="flex space-x-2">
            {/* Sentiment indicator */}
            <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs border ${getSentimentColor(news.sentiment)}`}>
